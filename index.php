...
<!-- POLAR TRACKER -->
<section id="polar_tracker" class="py-4 position-relative d-flex align-items-center">
    ...
    <div class="container px-4 py-5 ">
        <div class="row align-items-center">
            <figure class="col-12 col-md-6 mb-0 text-center">
                ...
                <img loading="lazy" src="/assets/images/dispositivo_desk.png" class="img-fluid d-none d-md-block" alt="Aplicações">
            </figure>
