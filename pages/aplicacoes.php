            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="800" data-aos-anchor-placement="top-bottom">
                <div class="card border-0 text-center">
                    <figure class="text-center">
                        ...
                        <img loading="lazy" class="img-fluid d-none d-sm-block mx-auto" width="269" height="202" src="../assets/images/thumbs/thumb_medicina_desk.webp" alt="Medicina Thumb">
                    </figure>

                    <p class="mb-0">MEDICINA</p>
                </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom">
                <div class="card border-0 text-center">
                    <figure>
                        ...
                        <img loading="lazy" class="img-fluid d-none d-sm-block mx-auto" width="269" height="202" src="../assets/images/thumbs/thumb_diagnostico_desk.webp" alt="Diagnóstico Thumb">
                    </figure>
                    <p class="mb-0">Pesquisa e Diagnóstico</p>
                </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="1500" data-aos-anchor-placement="top-bottom">
                <div class="card border-0 text-center">
                    <figure>
                        ...
                        <img loading="lazy" class="img-fluid d-none d-sm-block mx-auto" width="269" height="202" src="../assets/images/thumbs/thumb_saude-animal_desk.webp" alt="Saúde animal Thumb">
                    </figure>

                    <p class="mb-0">Saúde Animal</p>
                </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="1800" data-aos-anchor-placement="top-bottom">
                <div class="card border-0 text-center">
                    <figure>
                        ...
                        <img loading="lazy" class="img-fluid d-none d-sm-block mx-auto" width="269" height="202" src="../assets/images/thumbs/thumb_logistica_desk.webp" alt="Logística Thumb">
                    </figure>
            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="2000" data-aos-anchor-placement="top-bottom">
                <div class="card border-0 text-center">
                    <figure>
                        ...
                        <img loading="lazy" class="img-fluid d-none d-sm-block mx-auto" width="269" height="202" src="../assets/images/thumbs/thumb_farmaceutica_desk.webp" alt="Indústria Thumb">
                    </figure>
                    <p class="mb-0">Indústria Farmacêutica</p>
                </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="2500" data-aos-anchor-placement="top-bottom">
                <div class="card border-0 text-center">
                    <figure>
                        ...
                        <img loading="lazy" class="img-fluid d-none d-sm-block mx-auto" width="269" height="202" src="../assets/images/thumbs/thumb_tranposte_desk.webp" alt="Transporte Thumb">
                    </figure>
                    <p class="mb-0">Transporte e Armazenamento de Vacinas</p>
                </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="2800" data-aos-anchor-placement="top-bottom">
                <div class="card border-0 text-center">
                    <figure>
                        ...
                        <img loading="lazy" class="img-fluid d-none d-sm-block mx-auto" width="269" height="202" src="../assets/images/thumbs/thumb_food-service_desk.webp" alt="Food service Thumb">
                    </figure>

                    <p class="mb-0">Food Service</p>
                </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-duration="2800" data-aos-anchor-placement="top-bottom">
                <div class="card border-0 text-center">
                    <figure>
                        ...
                        <img loading="lazy" class="img-fluid d-none d-sm-block mx-auto" width="269" height="202" src="../assets/images/thumbs/thumb_camara_desk.webp" alt="Câmara Thumb">
                    </figure>
                    <p class="mb-0">Câmaras Frias</p>
                </div>
            </div>
        </div>
    </div>
